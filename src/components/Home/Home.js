        ...
        <div id="inicio" className="seccionNoTop">
            {playi === true ? 
                ...
                <div className='areaPlayPause'>
                    <button className='botonPlayPause' onClick={playPause}>││</button>
                </div></> : 
                <><ReactPlayer
                url={require('../../media/videos/videoBicicleta.mp4')}
                width='100%'
            ...
            <div className='areaVolumen'>
                {volOnOff === 0 ? 
                    <button className='botonVolumen' onClick={volumenOnOff}>On Volumen</button>:
                    <button className='botonVolumen' onClick={volumenOnOff}>Off Volumen</button>}
            </div>
